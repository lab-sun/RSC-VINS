...
class PoseGraph {
 public:
  ...
  void addKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop, int external_loop_index = -1);
 ...
 public:
  std::shared_ptr<NetvladDetector> netvlad_detector_ = nullptr;
  bool use_netvlad_loop_ = true;
};
