...
#include "netvlad_initial/netvlad_initializer.h"
...
class Estimator {
 public:
  ...
  bool use_netvlad_init_ = false;
  uint32_t continue_retrieve_ = 0u;
  std::shared_ptr<NetVladInitializer> netvlad_initializer_ = nullptr;
  std::string area_id_ = "mh_02";
};
